...
/**
 * 自动约束：约束就是约束下控件的相对位置更精确，相对于父级控件的位置, 因为要支持选择部分控件单独出码，所以要约束
 * 
 * views每一层childViews进行排序，计算兄弟间间距，都放到约束专属的字段里,
 * 
 ```js
constraints: 
constraint_bottom: "15.99432373046875"
constraint_height: "51"
constraint_is_center_x: true
constraint_is_center_y: true
constraint_left: "15.99432373046875"
constraint_right: "15.99432373046875"
constraint_top: "15.99432373046875"
constraint_width: "302"
```
 */
